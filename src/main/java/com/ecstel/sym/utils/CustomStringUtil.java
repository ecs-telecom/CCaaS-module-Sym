...
public class CustomStringUtil
{
    ...
    /**
     * <p>
     * 오라클의 decode 함수와 동일한 기능을 가진 메서드이다. <code>sourStr</code>과 <code>compareStr</code>의 값이 같으면 <code>returStr</code>을 반환하며, 다르면
    ...
    /**
     * <p>
     * 오라클의 decode 함수와 동일한 기능을 가진 메서드이다. <code>sourStr</code>과 <code>compareStr</code>의 값이 같으면 <code>returStr</code>을 반환하며, 다르면 <code>sourceStr</code>
     * 을 반환한다.
     * </p>
     *
     * <pre>
     ...
     * String(문자열.getBytes("바꾸기전 인코딩"),"바꿀 인코딩"); String temp = new String(문자열.getBytes("8859_1"),"KSC5601"); => UTF-8 에서 EUC-KR
     *
     * @param srcString
     *            - 문자열
     * @param srcCharsetNm
    ...
    {
        if (date.length() == 8) return date.substring(0, 4).concat("-").concat(date.substring(4, 6)).concat("-").concat(date.substring(6, 8));
        else return "";
    }
    /**
     *  웹페이지 <BR> replace
    ...
    public static String replaceBrString(String str)
    {
